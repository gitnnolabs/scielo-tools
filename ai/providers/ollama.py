...
class OllamaProvider:
    def __init__(self, model, response_format=None, temperature=0.0, top_p=0.1, max_tokens=4000, stop=None):
        self.model = model
    ...
    def chat_with_images(self, images, prompt, model=None):
        ...
        logger.info("Ollama vision. Model=%s images=%d prompt=%r", model_name, len(images), prompt[:150])
