...
# Example citation data used for few-shot prompting with LLM-based reference parsing.
# This file is used by the LLM-based reference marker.
# See also ai/prompts/back_gemini.py for the Gemini-specific prompt variant.
MESSAGES = [
        {   'role': 'system',
